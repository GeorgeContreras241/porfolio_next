  ...
  return (
    ...
    >
      <div className="flex flex-col flex-wrap justify-center px-4">
        ...
        >
          Tecnólogo en Desarrollo de Software, enfocado en frontend. Apasionado
          por crear interfaces modernas, eficientes, combinando diseño,
          rendimiento y buenas prácticas de desarrollo.
        </motion.p>
        <motion.span
          className="absolute z-9999 bg-red-500/30 bottom-10 left-4 font-extrabold lg:text-lg text-md border border-red-600 rounded-md py-2 px-6">
          Este Portafolio aun este en desarrollo
        </motion.span>
        <motion.div
